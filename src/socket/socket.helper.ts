export const checkWhoPlayedLastAlgF = (array: string[], input: string) => {
...
export  const gameWinnerCheckerF = (array: string[]) => {
     let winner = null
    // To know if they can go ahead to check i f there is a winner
    let canCheckWinner:boolean = true
    let winnerSign:string = ""
    let position:string = ""
    ...
    const changeVariablesF = (winnerSignValue:string, positionValue:string, winnerValue:boolean) => {
