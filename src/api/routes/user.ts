...
userRoute.post("/verifyForgotPassword", userC.verifyResetForgotPasssord)
userRoute.get("/verifyFogotPasswordToken", userC.verifyForgotPasswordToken)
userRoute.put("/newForgotPassword", userC.newForgotPassword)
